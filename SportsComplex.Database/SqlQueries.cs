...
";
        ...
        //public const string SqlAddTournment = "INSERT INTO [SportsComplex].[dbo].[Tournment] ([Name],[Fees],[CreatedDate],[LastDate],[IsDeleted]) VALUES('{0}','{1}',convert(date , '{2}' , 105),convert(date , '{3}' , 105),'{4}')";
